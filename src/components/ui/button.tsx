  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-warm hover:scale-105 border-2 border-primary/20 font-semibold",
        cultural: "bg-gradient-cultural text-white hover:shadow-cultural hover:scale-105 border-2 border-spiritual/20 font-semibold",
        spiritual: "bg-spiritual text-spiritual-foreground hover:bg-spiritual/90 shadow-cultural hover:shadow-lg hover:scale-105",
      },
      size: {
